...
interface DashboardSidebarProps {
    ...
    onShowAnalysis: () => void;
    onUploadClick?: () => void;
    onShowSettings: () => void; // Added for business settings
    onShowOrders?: () => void;
    hasNewOrders?: boolean;
}

export default function DashboardSidebar({ chats, activeChat, onSelectChat, onShowAnalysis, onUploadClick, onShowSettings, onShowOrders, hasNewOrders }: DashboardSidebarProps) {
    return (
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="p-2 hover:bg-amber-50 rounded-full transition-colors group relative"
                            title="Recent Orders"
                        >
